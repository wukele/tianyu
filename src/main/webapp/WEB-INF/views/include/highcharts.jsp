...
<script src="${ctx}/static/plugins/Highcharts-3.0.2/js/highcharts.js"></script>
<script src="${ctx}/static/plugins/Highcharts-3.0.2/js/pluginss/exporting.js"></script>
<script src="${ctx}/static/plugins/Highcharts-3.0.2/js/pluginss/canvas-tools.js"></script>
