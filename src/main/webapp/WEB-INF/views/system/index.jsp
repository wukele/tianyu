<%@page import="com.ty.tianyu.system.entity.User"%>
    ...
    <div id="mainLayout" class="easyui-layout hidden" data-options="fit: true">
        <div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
            <div id="topbar" class="top-bar">
            	<img src="${ctx }/static/plugins/easyui/common/bg1.jpg" style="position: absolute;">
                <div class="top-bar-left">
                    <h1 style="margin-left: 10px; margin-top: 10px;color: #fff">后台管理系统</h1>
                </div>
            ...
            <div id="toolbar" class="panel-header panel-header-noborder top-toolbar">
                ...
                <div id="buttonbar">
                    ...
                    <a href="javascript:void(0);" class="easyui-menubutton" data-options="menu:'#layout_north_set'" iconCls="icon-hamburg-settings">系统</a>  
            ...
            <div id="mainTabs_tools" class="tabs-tool">
                <table>
                    <tr>
                        ...
                        <td><div class="datagrid-btn-separator"></div></td>
                        <td><a id="mainTabs_refTab" class="easyui-linkbutton easyui-tooltip" title="刷新当前选中的选项卡" data-options="plain: true, iconCls: 'icon-hamburg-refresh'"></a></td>
                        <td><div class="datagrid-btn-separator"></div></td>
